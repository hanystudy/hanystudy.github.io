...
![Ruby Web服务器发展时间轴](http://content.hanyi.name/images/ruby_web_servers/timeline.png)
...
![Web服务器和CGI](http://content.hanyi.name/images/ruby_web_servers/cgi.png)
...
![Web服务器和FastCGI/SCGI服务器](http://content.hanyi.name/images/ruby_web_servers/fastcgi.png)
...
![Web服务器和多FastCGI/SCGI服务器](http://content.hanyi.name/images/ruby_web_servers/fastcgi_advance.png)
...
![Mongrel Web服务器](http://content.hanyi.name/images/ruby_web_servers/mongrel.png)
...
![Rack中间件](http://content.hanyi.name/images/ruby_web_servers/rack.png)
...
![Reactor模型](http://content.hanyi.name/images/ruby_web_servers/reactor.png)
...
![Unicorn的多进程模型](http://content.hanyi.name/images/ruby_web_servers/unicorn.png)
...
![Raptor的优化模型](http://content.hanyi.name/images/ruby_web_servers/raptor.png)
