...
　　3区选择是否支持Windows Sockets，当选择此项目时，应用程序能在 TCP/IP <a target="_blank" href="http://product.yesky.com/net/" class="bluekey"><font color="#003399">网络</font></a>上进行通信。 CWinApp派生类的InitInstance成员函数会初始化通讯端的支持，同时工程中的StdAfx.h文件会自动include &lt;AfxSock.h&gt;头文件。
